...
- **ルール**：`ルール/01_基本ルール.md`〜`08_用語集.md` — 特に 04（戦闘）、05（パワー）、06（キーワード）、07（効果処理）
...
40枚ちょうどか、同名3枚以下か、カード定義が揃っているか、リーダーのパワースキルがあるかを見る。
...
- **検証（Step3）を飛ばして数字を出さない。** AIの悪手はバグと同じで数字を大きく動かす。
  実例：後攻のアグロが初手の1MPをパワー溜めに使い何も展開しない悪手を直しただけで、

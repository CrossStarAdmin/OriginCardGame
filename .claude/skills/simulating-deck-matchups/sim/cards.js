...
const CARD_DB = {
  ...
  '火の子':         { kind: 'unit', cost: 1, atk: 2, hp: 1 },
  ...
  '師ベルゼ':       { kind: 'unit', cost: 6, atk: 4, hp: 5 },

  // ---- ミッドレンジ奇数エルナ（星詠み）----
  'オルレアの民':   { kind: 'unit', cost: 1, atk: 2, hp: 2 },
  '使い魔サキュ':   { kind: 'unit', cost: 1, atk: 2, hp: 1 },
  '凶兆のまたたき': { kind: 'unit', cost: 1, atk: 1, hp: 1 },
  '一手先を読む':   { kind: 'spell', cost: 1, dmg: 1 },
  '夜番の観測者':   { kind: 'unit', cost: 3, atk: 3, hp: 3 },
  '守り役オルド':   { kind: 'unit', cost: 3, atk: 2, hp: 3, kw: ['守護'] },
  '姉マイア':       { kind: 'unit', cost: 3, atk: 3, hp: 3 },
  ...
  '双つの未来':     { kind: 'unit', cost: 6, atk: 5, hp: 5, kw: ['突進'] },
...
const DECKS = {
  ...
  'ミッドレンジ奇数エルナ': {
    ...
    leader: 'エルナ',
    list: {
      'オルレアの民': 3, '使い魔サキュ': 3, '凶兆のまたたき': 3, '一手先を読む': 3,
      '夜番の観測者': 3, '守り役オルド': 3, '姉マイア': 3, '相棒ヴァルザ': 3,
      '深読み': 3, '写し手ヨナ': 3, '天文台の護り': 3, '双つの未来': 2,

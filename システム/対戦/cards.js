...
const CARD_DB = {
  ...
  'マルカ':         { kind: 'unit', cost: 1, atk: 1, hp: 2 },
  'ポルカ':         { kind: 'unit', cost: 2, atk: 3, hp: 2 },
  'ギズモ':         { kind: 'unit', cost: 3, atk: 2, hp: 2, kw: ['突進', '勇気'] },
  '焔弾':           { kind: 'spell', cost: 2, dmg: 3 },
  '教授ハルド':     { kind: 'unit', cost: 3, atk: 3, hp: 4, kw: ['ブースト'] },
  '火口の洞守り':   { kind: 'unit', cost: 3, atk: 2, hp: 4, kw: ['守護'] },
  '焼き払い':       { kind: 'spell', cost: 4 },
  'ドロテ':         { kind: 'unit', cost: 4, atk: 3, hp: 5, kw: ['必殺'] },
  '憤怒のヴェルド': { kind: 'unit', cost: 5, atk: 5, hp: 2, kw: ['突進'], tag: '六罪' },
  ...
  '傷ついた巡礼者': { kind: 'unit', cost: 2, atk: 3, hp: 4, kw: ['守護'] },
  '長屋の病人':     { kind: 'unit', cost: 2, atk: 2, hp: 3, kw: ['勇気'] },
  '怪我をした修道女キーラ': { kind: 'unit', cost: 3, atk: 2, hp: 2, tag: '聖徒' },
  '謎の日記':     { kind: 'spell', cost: 3 },
  '聖獣キメラ':     { kind: 'unit', cost: 4, atk: 2, hp: 5, kw: ['守護'] },
  '聖騎士ザキエル': { kind: 'unit', cost: 5, atk: 2, hp: 4, tag: '聖徒' },
  '老司祭ドラン':   { kind: 'unit', cost: 5, atk: 2, hp: 2, kw: ['守護'], tag: '聖徒' },
  '怒れる聖職者アン': { kind: 'unit', cost: 5, atk: 2, hp: 4, tag: '聖徒' },
  '死のパレード':   { kind: 'spell', cost: 6 },
  '偽善のミゼリア': { kind: 'unit', cost: 7, atk: 5, hp: 5, kw: ['守護', '勇気'], tag: '六罪' },
  '聖鳥リフルエル': { kind: 'unit', cost: 10, atk: 7, hp: 7, kw: ['勇気'] },

  // ---- ランプヴァルカス（デーモン）----
  '無様な魔物':     { kind: 'unit', cost: 1, atk: 1, hp: 1 },
  '貪りの供物':     { kind: 'spell', cost: 2 },
  '檻の番人':       { kind: 'unit', cost: 2, atk: 1, hp: 3, kw: ['守護'] },
  '魔王の復活':     { kind: 'spell', cost: 2 },
  '玉座の使い魔':   { kind: 'unit', cost: 2, atk: 2, hp: 2, kw: ['勇気'] },
  '眷属':           { kind: 'unit', cost: 2, atk: 3, hp: 2, kw: ['突進'] },
  ...
  // ---- ミッドレンジガイル（ウォーリア）----
  'ロダンの傭兵':   { kind: 'unit', cost: 1, atk: 2, hp: 1 },
  '番犬ゴロ':       { kind: 'unit', cost: 1, atk: 1, hp: 2, kw: ['勇気'] },
  '兵士の剣':       { kind: 'weapon', cost: 2, atk: 2 },
  '踏み込み':       { kind: 'spell', cost: 1 },
  '傭兵仲間リナ':   { kind: 'unit', cost: 2, atk: 2, hp: 2 },
  '鍛冶師ドヴァル': { kind: 'unit', cost: 3, atk: 2, hp: 2 },
  '砦の古参兵':     { kind: 'unit', cost: 4, atk: 4, hp: 5, kw: ['守護'] },
  '兵士長サム':     { kind: 'unit', cost: 4, atk: 4, hp: 5 },
  '剣術学校の師範': { kind: 'unit', cost: 3, atk: 2, hp: 4, kw: ['勇気'] },
  '一騎打ち':       { kind: 'spell', cost: 3 },
  'ロダンの重装兵': { kind: 'unit', cost: 2, atk: 2, hp: 3, kw: ['守護'] },
  '裏切りのグラーク': { kind: 'unit', cost: 6, atk: 7, hp: 9, kw: ['突進', '守護', '勇気'], tag: '六罪' },
  'ドヴァルの遺作': { kind: 'weapon', cost: 7, atk: 4 },
  '兄ゲイン':       { kind: 'unit', cost: 5, atk: 5, hp: 5 },
...
const DECKS = {
  'アグロリーゼ': {
    ...
    list: {
      ...
      '火口の洞守り': 3, '焼き払い': 3, 'ドロテ': 3, '憤怒のヴェルド': 2,
      '消えぬ焔': 3, '師ベルゼ': 2,
    },
  },
  'ミッドレンジ奇数エルナ': {
  ...
  'ミッドレンジガイル': {
    ...
    list: {
      ...
      '剣術学校の師範': 3, '一騎打ち': 3, 'ロダンの重装兵': 2, '裏切りのグラーク': 3,
